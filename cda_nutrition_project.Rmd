...
```{r}
df_modified_bloodpressure_demography|>
  dplyr::select(c("nh_black_white","SEQN","blood_pressure","clg_education","RIAGENDR","DMDYRUSR"))|>
...
```{r}
nh_bp_gender_table <- table(nh_bp_edu_gender_immigration[,"blood_pressure"], nh_bp_edu_gender_immigration[,"RIAGENDR"])
